...
print("Vil du lave en liste")
svar = input()

if svar ==("Ja"):
    print("Indtast Første Tal")
    firsttal = int(input())
    print("Indtast Andet Tal")
    secondtal = int(input())
    print("Indtast Trejde Tal")
    thirdtal = int(input())
...
# def print_repeatedly():
   # numberrange = range(gange)
   # for _ in numberrange:
      #  print(printting)

def print_repeatedly():
    print(printting * gange)

def print_pattern():
    print(printting * firsttal)
    time.sleep(2)
    print(printting * secondtal)
    time.sleep(2)
    print(printting * thirdtal)
